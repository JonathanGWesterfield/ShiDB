...
public class TransactionRegistrySingleton_old {
    ...
    private static volatile TransactionRegistrySingleton_old instance;
    ...
    private TransactionRegistrySingleton_old() {
    ...
    public static TransactionRegistrySingleton_old getInstance() {
        TransactionRegistrySingleton_old result = instance;
        if (result == null) {
            synchronized (mutex) {
                result = instance;
                if (result == null)
                    instance = result = new TransactionRegistrySingleton_old();
            }
        }
        return result;
    }
