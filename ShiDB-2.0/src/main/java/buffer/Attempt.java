 ...
 * 3. Checking for null doesn't actually tell me why something failed
 *
 * I don't want to use Optional because while it solves point 1, it just dresses up point 2 with lipstick. I still
 * have to manually check for null, just using the Optional class as a wrapper. It also just leaves point 3
 * completely unmolested. I'm sure I'm just ignant don't understand why Java programmers are ok with this
 *
 ...
 * in which case I might replace this)
 */
